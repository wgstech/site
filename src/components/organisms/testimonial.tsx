		...
		<div className="pt-24 pb-16 sm:pt-32 sm:pb-24 xl:pb-32">
			<div className="bg-gray-900 pb-20 sm:pb-24 xl:pb-0">
				<div className="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
					<div className="-mt-8 xl:-mb-8 w-full max-w-2xl xl:w-96 xl:flex-none">
					...
					<div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
						<figure className="relative isolate pt-6 sm:pt-12">
							<svg
								...
								viewBox="0 0 162 128"
								aria-hidden="true"
								className="-z-10 absolute top-0 left-0 h-32 stroke-white/20"
							>
								<path
							...
							<figcaption className="text-base mt-8">
								<div className="text-white font-semibold">Judith Black</div>
								<div className="text-gray-400 mt-1">CEO of Workcation</div>
							</figcaption>
						</figure>
					</div>
				</div>
