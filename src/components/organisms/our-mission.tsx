...
export function OurMission() {
  return (
    <Section id="nossa-missao" container={false}>
      <div className="px-6 max-md:text-center lg:px-8">
        <SectionTitle className="mb-20 text-center text-pretty">
          Nossa Missão
        </SectionTitle>
        <div className="mx-auto mt-6 flex items-center justify-center gap-20 max-md:flex-col">
          <div className="flex max-w-2xl flex-col max-md:items-center lg:flex-1">
            <MotionInView
              as="p"
              className="motion-safe:motion-preset-slide-up motion-delay-200 text-xl/8 text-pretty text-slate-700"
            >
            ...
            <MotionInView
              as="p"
              className="motion-delay-400 motion-safe:motion-preset-slide-up mt-10 max-w-xl text-base/7 text-pretty text-slate-600"
            >
...
function Stat({ name, value, hasPlus = false, duration = 1500 }: StatProps) {
  return (
    <div className="flex flex-col-reverse gap-y-2 max-md:items-center">
      <dt className="w-fit text-sm leading-7 font-medium text-slate-500">
        {name}
      </dt>
      <dd className="w-fit text-5xl font-semibold tracking-tight text-blue-700">
