	...
	return (
		<MotionInView
			className={cn(
				...
				"text-slate-800 text-center text-balance",
				"motion-safe:motion-preset-fade-lg motion-safe:motion-slide-up-lg",
				className,
			)}
		>
			<Icon weight="fill" className="size-15 text-sky-800" />
			<h3 className="font-semibold font-montserrat text-2xl text-sky-800">
				{title}
			</h3>
			{children}
		</MotionInView>
