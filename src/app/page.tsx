	...
	return (
		<main className="mx-auto grid grid-flow-row gap-32 bg-slate-100">
			<section className="h-[95vh] p-8 flex flex-col gap-4 items-center justify-center bg-transparent text-slate-100 z-20">
				<VideoBackground />
				<h1 className="font-bold text-5xl text-center motion-safe:motion-preset-fade-lg motion-safe:motion-preset-slide-up-lg">
					Otimize Sua Infraestrutura de TI e Reduza Custos
				</h1>
				<p className="text-slate-300 text-balance text-lg text-center motion-safe:motion-preset-fade-lg motion-safe:motion-preset-slide-up-lg motion-delay-700">
