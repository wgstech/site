...
export function HeroSection() {
	return (
		<section className="flex flex-1 flex-col items-center justify-center gap-4 bg-transparent p-8 text-slate-100">
			<h1 className="motion-safe:motion-preset-slide-up-lg text-pretty text-center font-semibold text-4xl tracking-tight md:text-5xl">
				Otimize Sua Infraestrutura de TI e Reduza Custos
			</h1>
			<p className="motion-delay-700 motion-safe:motion-preset-slide-up-lg text-pretty text-center text-lg/8 text-slate-300">
