...
const sliderToMachineCount = [2, 5, 8, 10, 15, 20, 40, 50, 100, 1000];
...
export function PricingSection() {
	...
	return (
		<>
			<div className="mx-auto my-12 max-w-2xl gap-4">
				<Slider
					min={0}
			...
			<div className="lg:-mx-8 xl:-mx-4 container mx-auto mt-4 grid grid-cols-1 gap-y-16 max-sm:max-w-sm max-md:divide-y lg:mt-20 lg:grid-cols-3 lg:divide-x">
				{prices.map((price) => (
